        ...
        <div className="container mx-auto px-4 h-16 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="relative w-10 h-10 overflow-hidden rounded-xl shadow-sm">
              <Image
                src="/images/icon.png"
                alt="EDGE IPTV icon - Best IPTV player app for iPhone and iPad"
                fill
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
              <DownloadButton
                location="home-hero"
                size="lg"
                className="rounded-full text-lg h-14 px-8 shadow-xl shadow-primary/20 hover:shadow-primary/30"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              EDGE IPTV is built with performance and user experience in mind.{" "}
              <Link
                href="/blog/best-iptv-player-ios-2026"
                className="text-primary hover:underline"
              >
                See why EDGE IPTV is rated #1
              </Link>{" "}
              in comprehensive 2026 comparison tests.
            </p>
          </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              A beautiful, intuitive interface that puts your content front and
              center.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto bg-card border border-border/50 rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold mb-6 tracking-tight">
              Ready to start streaming with EDGE IPTV?
            </h2>
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Join thousands of users who have upgraded their streaming
              experience with EDGE IPTV.{" "}
              <Link
              ...
              with our step-by-step EDGE IPTV installation guide.
            </p>
            <DownloadButton
