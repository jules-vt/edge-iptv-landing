  ...
  return (
    <div className="min-h-screen bg-background font-sans selection:bg-primary/20">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/40 supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-16 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link href="/es/blog" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">
              Blog
            </Link>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <Badge variant="secondary" className="mb-4">Interfaz</Badge>
            <h2 className="text-3xl lg:text-4xl font-bold tracking-tight">Diseñado para la Simplicidad</h2>
            <p className="text-lg text-muted-foreground">
              Una interfaz hermosa e intuitiva que pone tu contenido en primer plano.
            </p>
          </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto bg-card border border-border/50 rounded-3xl p-8 md:p-16 shadow-2xl relative overflow-hidden">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold mb-6 tracking-tight">¿Listo para comenzar a transmitir?</h2>
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Únete a miles de usuarios que han mejorado su experiencia de streaming. Descarga EDGE IPTV hoy.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-8 text-sm font-medium text-muted-foreground">
              <Link href="/es/privacy-policy" className="hover:text-primary transition-colors">Política de Privacidad</Link>
              <Link href="/es/terms-of-use" className="hover:text-primary transition-colors">Términos de Uso</Link>
              <Link href="/es/como-instalar-iptv-iphone-ipad" className="hover:text-primary transition-colors">Cómo Instalar</Link>
            </div>
          </div>
